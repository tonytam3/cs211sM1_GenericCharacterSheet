...
public enum PathfinderLevelFormat {
	...
	private int choice;
	private int[] arrayToUse;

	private static int[] slow = { 0, 0, 3000, 7500, 14000, 23000, 35000, 53000, 77000, 115000, 160000, 235000, 475000,
			665000, 955000, 1350000, 1900000, 2700000, 3850000, 5350000 };
	private static int[] medium = { 0, 0, 2000, 5000, 9000, 15000, 23000, 35000, 51000, 75000, 105000, 155000, 220000,
			315000, 445000, 635000, 890000, 1300000, 1800000, 2550000, 3600000 };
	private static int[] fast = { 0, 0, 1300, 3300, 6000, 10000, 15000, 23000, 34000, 50000, 71000, 105000, 145000,
